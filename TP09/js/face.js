...
class FaceExpressif {
    ...
    draw () {
        ...
        switch (this.expression) {
            case 0 : // notexpressif                     // TODO:  0 pour not sxpressif et puis tourner sur 1-3
...
function FaceNoExpressif (canvas, cx, cy, r, style, vx=0, vy=0) {
    this.canvas = canvas ;
    this.cx = cx ;
    this.cy = cy ;
    this.vx = vx ;
...
FaceNoExpressif.prototype.draw = function () {
    this.head.cx =  this.cx ;
    this.head.cy =  this.cy ;
    this.head.draw() ;
    this.mouth.cx =  this.cx ;
...
FaceNoExpressif.prototype.deplacer = function () {
    this.cx = this.cx + this.vx ;
    this.cy = this.cy + this.vy ;
    effacer(canvas) ;
    this.draw() ;
